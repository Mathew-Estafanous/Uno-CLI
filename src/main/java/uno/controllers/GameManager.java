...
import uno.players.AIPlayer;
import uno.players.Player;
import uno.players.RealPlayer;
...
public class GameManager {
     ...
     * The following instance variables will be used to keep
    ...
    private void gameLoop() {
        ...
        /* To use the chosen card, we call 'userCard' which will return an object
         * that defines how the card can be used. */
